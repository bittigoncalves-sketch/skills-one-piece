...
- 0,7–2,0 s: o shader do próprio céu muda gradualmente para dourado e centenas
  de luzes em cruz aparecem suspensas como estrelas; não existe disco ou cúpula
  geométrica visível.
...
- `tools/dev_tests/test_pika_c_v.gd`: cobre teleporte, alvo automático,
  sustentação/soltura e início da chuva.
- `multimodal/sessions/20260904-111249-pika_c_yasakani_e_v_chuva_de_luz/validacao/capturas/full/pika_pika_C_full.mp4`:
  captura de 4 s usando o caminho real de pressionar e manter C.
- `multimodal/sessions/20260904-111249-pika_c_yasakani_e_v_chuva_de_luz/validacao/capturas/ceu_dourado_v2/pika_pika_V_ceu_dourado_final.mp4`:
  captura de 14,5 s, incluindo intensidade máxima e dissipação.

As capturas usam câmera real, 30 fps fixos e não produziram erros de ciclo de
vida. A chuva visual cria riscos adicionais sem `DamageZone`; somente as
descargas principais consomem o orçamento do V.
